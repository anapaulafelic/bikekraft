...
wp_deregister_script('jquery');
	...
	wp_register_script( 'plugins-scripts', get_template_directory_uri() . '/js/plugins.js', [], false, true );
	
	// Registrar Script
	wp_register_script( 'main-script', get_template_directory_uri() . '/js/main.js', array( 'jquery', 'plugins-scripts' ), false, true );
...
//função para registrar e carregar o CSS
